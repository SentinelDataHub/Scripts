...
{ 
 ...
 echo " "
 echo "   -w <1...n>			: minutes to wait until retring the download of an offline product. Default value is 15;"
 echo " "
 echo " "
 echo "   -W <1...n>			: set number of download retries for offline products. Default value is 10."
 echo " "
 echo " "
